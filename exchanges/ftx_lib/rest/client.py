...
class FtxClient:
    ...
    def place_conditional_order_(self, market, side, trailValue, size, orderPrice=None,
                                         _type='stop', triggerPrice=None, reduceOnly=False, retryUntilFilled=True):
        """
        https://docs.ftx.com/?python#place-trigger-order

        :param market: the trading pair to query. e.g. "BTC/USD" for spot, "XRP-PERP" for futures
